...
PV.save?.();
window.PV13_IDENTITY_AUDIT={pinnedClubs:Object.keys(CLUB_IDS).length,pinnedLeagues:Object.keys(LEAGUE_CODES).length,source:'football-data.org crest CDN + existing verified assets'};
})();