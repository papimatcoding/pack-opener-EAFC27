...
assert(js.includes('verified deterministic crest URL or quiet fallback; never guessed identity'),'V0.18 identity policy missing');
assert(!/placeholder|best guess|guess or/i.test(js),'V0.18 deterministic registry contains guessed/placeholder identity');
console.log(`PackVerse V0.18 Spanish identity smoke OK · ${Object.keys(expected).length+1} high-priority verified Spanish mappings guarded`);
